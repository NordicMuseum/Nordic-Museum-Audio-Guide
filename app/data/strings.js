export const strings = {
  en: {
    ...
    aboutScreen_Overview: 'Lorem ipsum dolor sit amet.',
    aboutScreen_AboutHeader: 'Welcome to the Nordic Museum!',
    aboutScreen_AboutBody: 'The Nordic Museum is Sweden’s largest museum of cultural history. It is home to over one and a half million exhibits, including exclusive items and everyday objects, all with their own unique history. The collections, which are managed by the the Nordic Museum foundation, reflect life in Sweden from the 16th century to the present day. The museum has been referred to as a home for memories, but today it is a place where memories and innovations exist side by side. Please come and visit us!',
    aboutScreen_HoursHeader: 'Opening Hours',
    aboutScreen_HoursBody1: 'Monday–Sunday:',
    aboutScreen_HoursBody2: 'kl 10–17 (June–September: 09.00–18.00)',
    aboutScreen_HoursBody3: 'Open Wednesday evenings until 20.00 with free admission after 17.00 (not June-September).',
    aboutScreen_HoursBody4: 'The museum is closed on Midsummer’s Eve (24th june), Christmas Eve (24th december), Christmas Day (25th december) and New Years Eve (31st december).',
    aboutScreen_HoursMonday: 'Monday',
    aboutScreen_HoursMondayHours: '10.00–17.00',
    aboutScreen_HoursMondayHoursAccessibilityLabel: '10.00 to 17.00',
    aboutScreen_HoursTuesday: 'Tuesday',
    aboutScreen_HoursTuesdayHours: '10.00–17.00',
    aboutScreen_HoursTuesdayHoursAccessibilityLabel: '10.00 to 17.00',
    aboutScreen_HoursWednesday: 'Wednesday',
    aboutScreen_HoursWednesdayHours: '10.00–20.00',
    aboutScreen_HoursWednesdayHoursAccessibilityLabel: '10.00 to 20.00',
    aboutScreen_HoursThursday: 'Thursday',
    aboutScreen_HoursThursdayHours: '10.00–17.00',
    aboutScreen_HoursThursdayHoursAccessibilityLabel: '10.00 to 17.00',
    aboutScreen_HoursFriday: 'Friday',
    aboutScreen_HoursFridayHours: '10.00–17.00',
    aboutScreen_HoursFridayHoursAccessibilityLabel: '10.00 to 17.00',
    aboutScreen_HoursSaturday: 'Saturday',
    aboutScreen_HoursSaturdayHours: '10.00–17.00',
    aboutScreen_HoursSaturdayHoursAccessibilityLabel: '10.00 to 17.00',
    aboutScreen_HoursSunday: 'Sunday',
    aboutScreen_HoursSundayHours: '10.00–17.00',
    aboutScreen_HoursSundayHoursAccessibilityLabel: '10.00 to 17.00',
    aboutScreen_AdmissionHeader: 'Admission',
    aboutScreen_AdmissionBody1: 'Adults: 100 SEK',
    aboutScreen_AdmissionBody2: 'Children/Youth 18 years and under: free',
    aboutScreen_AdmissionBody3: 'Wednesdays 17.00–20.00 free entrance (October-May only).',
    aboutScreen_ForChildrenHeader: 'For Children',
    aboutScreen_ForChildrenBody: 'The Children’s Playhouse, admission: 20 SEK / child. Weekdays 11.00–17.00 and weekends 10.00–17.00. Suitable from age 5.',
  ...
  sv: {
    ...
    aboutScreen_Title: 'Om museet',
    aboutScreen_Overview: 'Lorem ipsum dolor sit amet.',
    aboutScreen_AboutHeader: 'Välkommen till Nordiska museet!',
    //aboutScreen_AboutBody: 'The Nordic Museum is Sweden’s largest museum of cultural history. It is home to over one and a half million exhibits, including exclusive items and everyday objects, all with their own unique history. The collections, which are managed by the the Nordic Museum foundation, reflect life in Sweden from the 16th century to the present day. The museum has been referred to as a home for memories, but today it is a place where memories and innovations exist side by side. Please come and visit us!',
    aboutScreen_HoursHeader: 'Öppettider',
    aboutScreen_HoursBody1: 'Alla dagar:',
    aboutScreen_HoursBody2: 'kl 10–17 (Juni–september: kl 9–18)',
    //aboutScreen_HoursBody3: 'Open Wednesday evenings until 20.00 with free admission after 17.00 (not June-September).',
    aboutScreen_HoursBody4: 'Museet är stängt på midsommarafton (24 juni), julafton (24  december), juldagen (25 december) och nyårsafton (31 december).',
    aboutScreen_HoursMonday: 'Måndag',
    aboutScreen_HoursMondayHours: 'kl 10–17',
    aboutScreen_HoursMondayHoursAccessibilityLabel: 'klockan 10 till 17',
    aboutScreen_HoursTuesday: 'Tisdag',
    aboutScreen_HoursTuesdayHours: 'kl 10–17',
    aboutScreen_HoursTuesdayHoursAccessibilityLabel: 'klockan 10 till 17',
    aboutScreen_HoursWednesday: 'Onsdag',
    aboutScreen_HoursWednesdayHours: 'kl 10–20',
    aboutScreen_HoursWednesdayHoursAccessibilityLabel: 'klockan 10 till 20',
    aboutScreen_HoursThursday: 'Torsdag',
    aboutScreen_HoursThursdayHours: 'kl 10–17',
    aboutScreen_HoursThursdayHoursAccessibilityLabel: 'klockan 10 till 17',
    aboutScreen_HoursFriday: 'Fredag',
    aboutScreen_HoursFridayHours: 'kl 10–17',
    aboutScreen_HoursFridayHoursAccessibilityLabel: 'klockan 10 till 17',
    aboutScreen_HoursSaturday: 'Lördag',
    aboutScreen_HoursSaturdayHours: 'kl 10–17',
    aboutScreen_HoursSaturdayHoursAccessibilityLabel: 'klockan 10 till 17',
    aboutScreen_HoursSunday: 'Söndag',
    aboutScreen_HoursSundayHours: 'kl 10–17',
    aboutScreen_HoursSundayHoursAccessibilityLabel: 'klockan 10 till 17',
    aboutScreen_AdmissionHeader: 'Entré',
    aboutScreen_AdmissionBody1: 'Vuxen, pensionär och student: 100 kr',
    aboutScreen_AdmissionBody2: 'Barn och ungdomar till och med 18 år: fri entré',
    aboutScreen_AdmissionBody3: 'Onsdagar kl 17–20 fri entré (oktober–maj).',
    aboutScreen_ForChildrenHeader: 'För barn',
    aboutScreen_ForChildrenBody: 'Lekstugan: barn 20 kr (ingår för vuxna i entréavgift till museet). Vardagar kl 11–17 och helger kl 10–17. Passar från 5 år.',
    // CHAPTER HEADERS
