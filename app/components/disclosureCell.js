...
import { Text, View, TouchableHighlight, Image, StyleSheet, I18nManager } from 'react-native';
...
const DisclosureCell = props => {
  return (
    ...
    >
      <View style={[styles.cell, props.bottomBorder === false ? { borderBottomWidth: 0 } : {}]}>
        <Text style={[{ writingDirection: I18nManager.isRTL ? 'rtl' : 'ltr' }, styles.cellTitle]}>
          <Text
