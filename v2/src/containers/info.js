...
import DisclosureCell, { DISCLOSURE_CELL_HEIGHT } from '../components/disclosureCell';
import { NAV_BAR_TEXT, NAV_BAR_BACKGROUND, OFF_BLACK, BOTTOM_BAR_HEIGHT }  from '../styles';
      ...
      <View style={[styles.container, { marginBottom: bottomOffset }]}>
        <View style={{ height: imageHeight }}>
          <Image
            ...
            style={[styles.image, { width, height: imageHeight, backgroundColor: 'red'}]}
