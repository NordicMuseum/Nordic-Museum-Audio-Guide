...
const AutoplayProgressView = props => {
  const { loadNextAutoplayAudio } = props.actions;

  const { timerActive, timerNumber, autoplayOn, timerStartAt } = props;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.row, styles.autoplayRow]} accessible={true}>
        <View>
