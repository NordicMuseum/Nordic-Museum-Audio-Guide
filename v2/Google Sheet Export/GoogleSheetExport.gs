...
function exportAllSheets(e) {
  ...
  var sheetsData = {};
  sheetsData["Timestamp"] = new Date().toString();
...
function displayText_(e, text) {
  // var json = makeJSON_(text, getExportOptions(e));
  // var JSONFile = DriveApp.createFile("raw.json", json);
  ...
  SpreadsheetApp.getUi()
      .showModalDialog(output, 'Copy/Paste the following content into ../src/data/raw.JSON');
}
